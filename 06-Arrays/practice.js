...
let sum = sumValue.reduce((accumulator, val) => { return accumulator + val }, 0);

// console.log(sum);

let less = [12, 15, 3, 8, 20];
let newLess = less.find((val) => { return val < 10 });

// console.log(newLess);


let studentMark = [45, 60, 28, 90];
let score = studentMark.some((val) => { return val < 35 });

// console.log(score);


let even = [2, 4, 6, 8, 10];
let ansEven = even.every((val) => { return val % 2 === 0 })
